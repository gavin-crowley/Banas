...
# Show how accurary fails after 15 digits
...
# Give 5 examples of escape sequences in var str1

# Demo a triple quoted string str2
...
#print 0001 Gavin 1.23 A

 
# ----- MATH -----
# Examples of 7 maths operators
# integer division disregards the remainder
 
# Shortcuts
# demo += and three others from above
...
# not converts trues into falses
# demo and
age = 20
    print("Stay Home")
    print("Kindergarten")
...
# Character at index
# print 1st char str 3
 
# Last character
# print last char str 3
 
# 1st 3 chrs
# Start, up to not including
